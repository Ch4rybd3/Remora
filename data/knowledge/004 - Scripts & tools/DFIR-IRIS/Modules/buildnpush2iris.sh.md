...
![screenshot](/knowledge-assets/8ba941fcad8142abb29a5db48e0f1a8a.png)
Run()
{
...
Some modifications were made from the one made by SOCFortress.
Basically : 
`python3.9 setup.py bdist_wheel`
to : 
`python3 setup.py bdist_wheel`
So the script can run with every python3 version you have.

And I replaced the name of the containers to : 
- `iriswebapp_app`
- `iriswebapp_worker`

Usage : 
You need to use sudo to launch the script, and you need the argument -a yo push it to both the app and worker container
