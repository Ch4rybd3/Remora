...
class BrowserFile(Base):
    """One uploaded WebX browser-history CSV file per case."""
    __tablename__ = "browser_files"
    ...
    artifact_type = Column(String(32),  nullable=False, default="generic")
